...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@MOJ.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+256 (0)784-152-803</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">MOJ<span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/Managing Director.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/makers4.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
			...
			<div class="contact-agileits">
				...
				<form  method="post" name="sentMessage" id="contactForm" >
                    ...
                    <div class="control-group form-group">
                            ...
                            <input type="tel" class="form-control" name="phone"  pattern="[0-9]{8,}" title="Minimum 14 numbers" maxlength="15" id="phone" required >
							<p class="help-block"></p>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<iframe src="https://www.google.com/maps/dir/0.440272,33.1968311/Kiira+Rd,+Jinja/@0.4401323,33.196278,201m/data=!3m1!1e3!4m8!4m7!1m0!1m5!1m1!1s0x177e7b8a089fd625:0x5514f8d9f7ba5938!2m2!1d33.196026!2d0.4399585" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
